    ...
    if (shell == null) {
      try {
        ...
        ic.with {
          ...
          addStaticStars 'pt.lsts.dolphin.dsl.Instructions'
          addStarImports 'pt.lsts.dolphin.dsl'
          addStarImports 'pt.lsts.dolphin.runtime'
        }
  ...
  void run(File scriptFile) {
    ...
    executionThread = new Thread() {
          ...
          public void run() {
            ...
            env.releaseAll()
			env.setErrorMode(new ErrorMode(ErrorMode.Type.IGNORE)) //reset error flag
