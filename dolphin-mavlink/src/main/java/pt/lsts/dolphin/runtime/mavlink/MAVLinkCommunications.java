...
public class MAVLinkCommunications extends Thread implements Debuggable {
    ...
    private MAVLinkCommunications() {
        ...
        msgHandler.bind(msg_mission_request_int.class, MAVLinkNode::consume);
        ...
        msgHandler.bind(msg_sys_status.class, MAVLinkNode::consume);
//        msgHandler.bind(msg_camera_image_captured.class, MAVLinkNode::consume);
    }
    ...
    private void handleIncomingMessages() {
        ...
        for (int i = 0; i < udpPacket.getLength(); i++) {
            ...
            if (message.msgid == msg_heartbeat.MAVLINK_MSG_ID_HEARTBEAT) {
                ...
                Engine.platform().displayMessage("HB from node %d (%s)", hbMsg.sysid, hbMsg.type);
